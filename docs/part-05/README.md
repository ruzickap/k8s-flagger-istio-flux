...
![Grafana screenshot - Canary deployment finished](./grafana-canary-completed.png
...
![Failing canary deployment](./tmux-canary-started-to-fail.png
"Failing canary deployment")

Failing canary deployment on Grafana dashboard:

![Grafana - Failing canary deployment](./grafana-failing-canary.png
...
![Grafana - Canary deployment failed](./grafana-canary-failed.png
